...
##########################################################################################################################################
def E_BiosynthesisFromNH4(ep):   #ep: energy efficiency for the production of energy and the consumption of energy

    C=6             #number of C in one carbohydrate (ex. C(glucose)=6)
    n=5             #number of C in one bacterial biomass (BB)
